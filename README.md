...
<div align="center" style="display: flex; flex-wrap: wrap; gap: 10px; justify-content: center;">
  <img src="prototypes/login.png" style="border-radius: 10px;">

  <img src="prototypes/dashboard.png" style="border-radius: 10px;">

  <img src="prototypes/dataEntry.png" style="border-radius: 10px;">

  <img src="prototypes/reportingAnalysis.png" style="border-radius: 10px;">
</div>
